...
template = """sistema
Analiza el documento proporcionado y responde las preguntas del usuario utilizando únicamente la información encontrada en el documento. Evita poner "La respuesta es:" antes de la respuesta.
